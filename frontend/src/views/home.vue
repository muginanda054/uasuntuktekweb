  ...
  <div class="">
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
      <div class="container flex flex-col items-center justify-between h-full max-w-6xl px-8 mx-auto -mt-32 lg:flex-row xl:px-0">
        <div class="z-30 flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
          <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Donasi, Wujudkan Impian Mahasiswa!</h1>
          <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Siapkah anda berkontribusi untuk mendukung mahasiswa sebagai agen perubahan?</p>
          <router-link :to="{ name: 'donasi' }" class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-indigo-600 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0"
            >Donasi Sekarang!</router-link
          >
        ...
        <div class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
          <div class="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
            <img src="" alt="Gambar Membantu" class="w-full h-auto mt-20 mb-20 ml-0 lg:mt-24 xl:mt-40 lg:mb-0 lg:h-full lg:ml-12" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="features" class="relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
      <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
        <h3 class="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-6xl">Tentang Kami</h3>
        <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-5 lg:mt-5">
          <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
            <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
              ...
              <h4 class="relative mt-6 text-lg font-bold">Visi & Misi Kami</h4>
              <p class="relative mt-2 text-base text-center text-gray-600">Menjebatani calon donatur dan calon penerima bantuan sesuai kebijakan yang berlaku.</p>
            </div>
          </div>
          ...
          <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
            <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
              ...
              <h4 class="relative mt-6 text-lg font-bold">Inovasi Layanan</h4>
              <p class="relative mt-2 text-base text-center text-gray-600">Memberikan dampak maksimal dalam mewujudkan perubahan positif.</p>
            </div>
          </div>
          ...
          <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
            <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
              ...
              <h4 class="relative mt-6 text-lg font-bold">Transparansi Tinggi</h4>
              <p class="relative mt-2 text-base text-center text-gray-600">Setiap donasi ditempatkan dengan tepat untuk membangun kepercayaan.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto">
        <div class="flex-col items-center">
          <div class="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
            <h2 class="text-4xl font-extrabold leading-10 tracking-tight text-gray-900 sm:text-5xl sm:leading-none md:text-6xl lg:text-5xl xl:text-6xl">Hubungi Kami</h2>
            <p class="my-6 text-xl font-medium text-gray-500">Kami tersedia melalui berbagai saluran komunikasi. Jangan ragu untuk menghubungi kami untuk menciptakan pengalaman yang lebih baik bersama.</p>
          </div>
          ...
          <div class="flex flex-col items-center justify-center max-w-2xl py-8 mx-auto xl:flex-row xl:max-w-full">
            <div class="w-full xl:w-1/2 xl:pr-8">
              <blockquote class="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                <div class="flex flex-col pr-8">
                  <div class="relative pl-12">
                    <p class="mt-2 text-base text-gray-600">prasastamugi@gmail.com<br />082145120960</p>
                  </div>

                  <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Komang Mugi Nanda Prasasta</h3>
                  <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                </div>
                <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="" alt="" />
              </blockquote>
              ...
              >
                <div class="flex flex-col pr-10">
                  <div class="relative pl-12">
                    <p class="mt-2 text-base text-gray-600">rama.prayoga@student.undiksha.ac.id<br />081246453917</p>
                  </div>
                  <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">I Gusti Ngurah Rama Prayoga</h3>
                  <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                </div>
                <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="" alt="" />
              </blockquote>
            ...
            <div class="w-full xl:w-1/2 xl:pl-8">
              <blockquote class="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                <div class="flex flex-col pr-10">
                  <div class="relative pl-12">
                    <p class="mt-2 text-base text-gray-600">bratha@student.undiksha.ac.id<br />081238331619</p>
                  </div>

                  <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">I Gusti Ngurah Bratha Wicaksana</h3>
                  <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                </div>
                <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="" alt="" />
              </blockquote>
              ...
              <blockquote class="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 mt-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                <div class="flex flex-col pr-10">
                  <div class="relative pl-12">
                    <p class="mt-2 text-base text-gray-600">valensianatalia24@gmail.com<br />081231390958</p>
                  </div>

                  <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Valensia Natalia</h3>
                  <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                </div>
                <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="" alt="" />
              </blockquote>
    ...
    <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
      <div class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2023 StudentHelper. All rights reserved.</div>
    </footer>
  </div>
</template>
